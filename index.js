...
UserVetData.find( { date: { $gt: new String('2018-01-01'), $lt: new String('2018-12-31') } } )
 ...
 UserVetData.find( { date: { $gt: new String('2017-01-01'), $lt: new String('2017-12-31') } } )
        .then(function(doc) {
          var totalCost7 = 0;
          console.log("doc lengtht: " + doc.length);
           ...
           for(var ii = 0; ii < doc.length; ii++) {
             console.log("doc.cost: " + doc[ii].cost);
             totalCost7 += parseFloat(doc[ii].cost);
          }
          UserFeedData.find({ date1: { $gt: new String('2017-01-01'), $lt: new String('2017-12-31') } })
              .then(function(doc) {
                var totalCost27 = 0;
                console.log("doc length: " + doc.length);
                 ...
                 for(var iii = 0; iii < doc.length; iii++) {
                   console.log("doc.price: " + doc[iii].price);
                   totalCost27 += parseFloat(doc[iii].price);
                 }
                 UserSupplyData.find({ date2: { $gt: new String('2017-01-01'), $lt: new String('2017-12-31') } })
                     .then(function(doc) {
                       var totalCost37 = 0;
                       console.log("doc length: " + doc.length);
                          ...
                          for(var jj = 0; jj < doc.length; jj++) {
                            console.log("doc.price2: " + doc[jj].price2);
                            totalCost37 += parseFloat(doc[jj].price2);
                          }

                          UserData.find({ dos: { $gt: new String('2017-01-01'), $lt: new String('2017-12-31') } })
                              .then(function(doc) {
                                var totalCost47 = 0;
                                console.log("doc length: " + doc.length);
                                   ...
                                   for(var jjj = 0; jjj < doc.length; jjj++) {
                                     console.log("doc.pur: " + doc[jjj].pur);
                                     totalCost47 += parseFloat(doc[jjj].pur);
                                   }
                                   UserData.find({ dos: { $gt: new String('2017-01-01'), $lt: new String('2017-12-31') } })
                                       .then(function(doc) {
                                     var totalCost57 = 0;
                                     console.log("doc length: " + doc.length);
                                        ...
                                        for(var kk = 0; kk < doc.length; kk++) {
                                          console.log("doc.sal: " + doc[kk].sal);
                                          totalCost57 += parseFloat(doc[kk].sal);
                                        }

  UserVetData.find( { date: { $gt: new String('2016-01-01'), $lt: new String('2016-12-31') } } )
         .then(function(doc) {
           var totalCost6 = 0;
           console.log("doc lengtht: " + doc.length);
            ...
            for(var ii = 0; ii < doc.length; ii++) {
              console.log("doc.cost: " + doc[ii].cost);
              totalCost6 += parseFloat(doc[ii].cost);
           }
           UserFeedData.find({ date1: { $gt: new String('2016-01-01'), $lt: new String('2016-12-31') } })
               .then(function(doc) {
                 var totalCost26 = 0;
                 console.log("doc length: " + doc.length);
                  ...
                  for(var iii = 0; iii < doc.length; iii++) {
                    console.log("doc.price: " + doc[iii].price);
                    totalCost26 += parseFloat(doc[iii].price);
                  }
                  UserSupplyData.find({ date2: { $gt: new String('2016-01-01'), $lt: new String('2016-12-31') } })
                      .then(function(doc) {
                        var totalCost36 = 0;
                        console.log("doc length: " + doc.length);
                           ...
                           for(var jj = 0; jj < doc.length; jj++) {
                             console.log("doc.price2: " + doc[jj].price2);
                             totalCost36 += parseFloat(doc[jj].price2);
                           }

                           UserData.find({ dos: { $gt: new String('2016-01-01'), $lt: new String('2016-12-31') } })
                               .then(function(doc) {
                                 var totalCost46 = 0;
                                 console.log("doc length: " + doc.length);
                                    ...
                                    for(var jjj = 0; jjj < doc.length; jjj++) {
                                      console.log("doc.pur: " + doc[jjj].pur);
                                      totalCost46 += parseFloat(doc[jjj].pur);
                                    }
                                    UserData.find({ dos: { $gt: new String('2016-01-01'), $lt: new String('2016-12-31') } })
                                        .then(function(doc) {
                                      var totalCost56 = 0;
                                      console.log("doc length: " + doc.length);
                                         ...
                                         for(var kk = 0; kk < doc.length; kk++) {
                                           console.log("doc.sal: " + doc[kk].sal);
                                           totalCost56 += parseFloat(doc[kk].sal);
                                         }
       ...
       res.render('index7', {totalProfit: totalCost, totalProfit2: totalCost2,
         ...
         totalProfit9: totalCost9, totalProfit29: totalCost29,
           ...
           totalProfit7: totalCost7, totalProfit27: totalCost27,
             totalProfit37: totalCost37, totalProfit47: totalCost47, totalProfit57: totalCost57,
             totalSpentAll7: totalCost7+totalCost27+totalCost37+totalCost47, totalNum7: totalCost57-(totalCost7+totalCost27+totalCost37+totalCost47),
             totalProfit6: totalCost6, totalProfit26: totalCost26,
               totalProfit36: totalCost36, totalProfit46: totalCost46, totalProfit56: totalCost56,
               totalSpentAll6: totalCost6+totalCost26+totalCost36+totalCost46, totalNum6: totalCost56-(totalCost6+totalCost26+totalCost36+totalCost46)});
